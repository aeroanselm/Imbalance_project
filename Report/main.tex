...
% 		\midrule
        ...
        \nomenclature{$d_m 		 $          }{Mean Diameter                                                            }%&\si{\meter}           	\\
		...
		\nomenclature{$l_F 	      $}{Fairing length           }
		\nomenclature{$l_{ESCA}   $}{ESC-A length             }
		\nomenclature{$l_{EPC}	  $}{EPC length               }
		\nomenclature{$l_{N_{EAP}}$}{EAP nose length          }
		\nomenclature{$x_f 	      $}{EAP flare position       }
		\nomenclature{$d_c 	      $}{Circle length            }
		\nomenclature{$d_{ESCA}   $}{ESC-A diameter           }
		\nomenclature{$d_f 	      $}{EAP flare diameter       }
		\nomenclature{$d_{e_{EAP}}$}{EAP exit nozzle diameter }
		\nomenclature{$M_F 	      $}{Fairing + Payload mass   }
		\nomenclature{$M_{ESCA}   $}{ESC-A mass               }
		\nomenclature{$M_{EPC}    $}{EPC mass                 }
		\nomenclature{$M_{EAP}    $}{EAP mass                 }
		\nomenclature{$o/f      $}{Oxidizer to fuel ratio}
% 		\bottomrule
% 	\end{tabular}
